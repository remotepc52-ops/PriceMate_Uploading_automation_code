...
today = first_monday_date.strftime("%Y_%m_%d")

MONGO_URI = "mongodb://localhost:27017/"  # Change this if needed
DATABASE_NAME = "pricemate_eshop_blibli_id"  # Replace with your DB name
COLLECTION_NAME = "Product_Data_2025_10_06"  # Replace with your collection name
# Export Settings
folder_path = fr"E:\Projects\Avhinandan\sample_pf_price\{today}"
...
def Export_Data(Website):
    ...
    data = list(product_data.find({"retailer": "blibli"}).limit(1000000))
    df = pd.DataFrame(data)

    # Specify the columns you want to export
    columns_to_export = ["Keyword",
                         "Organic/Paid", "Ranking",
                         "Country",
                         "Platform",
                         "Seller ID",
                         "Store name",
                         ...
                         "Selling Price",
                         "Monthly Item Sold",
                         "Historical Item Sold", "Avg Rating", "Total Review", "Category URL"]
...
if __name__ == '__main__':
    Website = "blibli"  # Change this to your actual website name
    Export_Data(Website)
