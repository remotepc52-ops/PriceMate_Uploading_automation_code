...
# }
#
# class VetCateSpider(PricemateBaseSpider):
#     name = "vet_site"
#
...
#         sitemaps = 'https://vetwarehouse.co.nz/product_cat-sitemap1.xml'
#
...
#     execute("scrapy crawl vet_site -a retailer=vetwarehouse-nz -a region=nz -a Type=eshop -a RetailerCode=vetwarehouse_nz".split())