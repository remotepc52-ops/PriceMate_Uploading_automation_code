...
class metroCateSpider(PricemateBaseSpider):
    name = "metro_cate"
...
if __name__ == '__main__':
    ...
    execute("scrapy crawl metro -a retailer=metromart_sm_hypermarket-ph -a region=ph -a Type=eshop -a RetailerCode=metromart_sm_hypermarket_ph".split())